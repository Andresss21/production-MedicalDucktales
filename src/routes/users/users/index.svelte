...
<script lang="ts">
  ...
  let result = null
    ...
    const url = variables.apiUri + `/users/${idToDelete}`;
...
<div class="card bg-neutral card-bordered">
  <div class="card-body text-neutral-content">
    <div class="card-title">
      ...
      <a href="users/new" class="btn btn-accent ml-auto">
        <Icon
          name="plus"
          width="1.5em"
          height="1.5em"
    ...
    <input type="checkbox" id="delete-users" class="modal-toggle">
    <div class="modal bg-white-500/75">
      <div class="modal-box w-11/12 max-w-5xl bg-accent">
        ...
        <div class="modal-action">
          <label for="delete-users" class="btn btn-ghost">Cancelar</label>
          <label for="delete-users" class="btn btn-primary" on:click="{doDelete}">Eliminar</label>
        </div>
      </div>
    </div>
